...
addQ(117, "Việt Nam thiết lập quan hệ đối tác chiến lược toàn diện với bao nhiêu nước lớn tính đến năm 2024?", "4", "5", "6", "7", "D");
...
addQ(131, "Công tác bảo vệ môi trường là trách nhiệm của?", "Chính phủ", "Người dân", "Toàn xã hội", "Các doanh nghiệp", "C");
...
console.log('Success: Full structure from 1-150 written.');
